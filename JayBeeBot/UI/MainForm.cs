...
namespace JayBeeBot.UI
{
    ...
    public partial class MainForm : Form
    {
        ...
        private async void LoadRaces()
        {
            ...
            serviceStatus.OutputMessage("Starting to load races...");
            ...
            if (marketCataloguesResult.IsSuccessResult)
            {
                ...
                if (marketsResult.IsSuccessResult)
                {
                    ...
                    serviceStatus.OutputMessage($"{races.Count} races has been loaded.");
                }
            }
            else
            {
                serviceStatus.OutputMessage("Failed to load today races.");
            }
        }
